    ...
    const testimonials = [
      {
        ...
        name: "Sarah Johnson",
        title: "Entrepreneur",
        quote: "This platform transformed how I manage my finances while connecting me with an amazing community of women."
      },
      {
        avatar: "https://randomuser.me/api/portraits/women/46.jpg",
        name: "Emily Chen",
        title: "Software Developer",
        quote: "The job search feature helped me find opportunities that truly value my skills and growth potential."
      },
      {
        avatar: "https://randomuser.me/api/portraits/women/86.jpg",
        name: "Amina Diallo",
        title: "Small Business Owner",
        quote: "The financial tools gave me the confidence to expand my business while maintaining healthy savings."
      },
    ];
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
          <div className="max-w-xl sm:text-center md:mx-auto">
            ...
            <p className="mt-3 text-gray-600">
              Join thousands of women who are achieving their financial and professional goals through our platform.
            </p>
          </div>
          <div className="mt-12">
            <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {testimonials.map((item, idx) => (
                <li key={idx} className="bg-white rounded-xl border">
                  <div className="p-4">
                    <svg
        ...
        <>
            ...
            <div className="services">
                ...
                <div className="cardContainer">
                    ...
                    <div className="card">
                        Goals
                        <span id='miniDescription'>Plan your goals in a SMART way</span>
                    </div>
                    <div className="card">
                        Communities
                    ...
                    <div className="card">
                        Economic Support
                        <span id='miniDescription'>Financial FREEDOM, tailored for you</span>
                    </div>
                    <div className="card">
                        Job Search
                    ...
                    <div className="card">
                        Safety Features
                        <span id='miniDescription'>Tools to help you feel secure</span>
                    </div>
                </div>
            </div>
            <hr />
